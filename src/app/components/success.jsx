...
check your mail box for next step<sub class="absolute md:right-[20px] bottom-3 right-0"><Image src="/emoji.png" width={15} height={10} alt="emoji"/></sub></p>
                    </div>
                    <div>
                    <button className="bg-gradient-to-r from-[#f927c1] to-[#9d39ff] p-2 rounded-sm md:w-[350px] w-[300px]"><Link href="/">Back</Link></button>
                    </div>
                </div>
