...
08:00am - 05:00pm</p>
        ...
        <Image src="/star3.png" width={20} height={400} alt="lens" class="absolute bottom-[80px] -left-2" style={{zIndex:522}}/>
          ...
          <Image src="/lens.png" width={2000} height={400} alt="lens" class="absolute -bottom-[200px] -right-[320px] hidden md:block" style={{zIndex:11}}/>
            ...
            <form class="flex flex-col md:gap-4 items-center justify-center mt-[20px] gap-[40px]" onSubmit={contactCall}>
            <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-col gap-2">
                       ...
                       <input type="text" placeholder="Topic" class="border-[2px] border-white bg-transparent p-[10px] md:w-[300px] w-[300px] placeholder:text-sm placeholder:text-white placeholder:pl-2 bg-[#1c152e] md:bg-none" value={topic} onChange={(e)=>setTopic(e.target.value)}/>
                   </div>
                    ...
                    <div class="flex flex-col gap-2">
                     ...
                     <div><button class="bg-gradient-to-r from-[#f927c1] to-[#9d39ff] p-2 rounded-sm w-[200px]">Submit</button></div>
            </form>
